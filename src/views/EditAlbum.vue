...
<!--                <el-table
                    ...
                    <el-table-column width="310"
                                     label="歌手名"
                    >
                        <template slot-scope="scopesinger" >
                            <el-form-item  :prop="'songs.' + scopesinger.$index + '.song_name'" >
                                <el-autocomplete
                                        class="inline-input"
                                        v-model="scopesinger.row.singer_name"
                    ...
                    <el-table-column
                            ...
                            width="50px">
                        <template slot-scope="scope">
                            <el-button @click="removeSinger(scope.row)" type="text" size="small">删除</el-button>
                        </template>
                    </el-table-column>
                </el-table>-->

<!--                <el-form-item>
                    <el-button @click="addSinger">新增歌手</el-button>
                </el-form-item><br>-->
                <el-select
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            fetch(this.albumurl + "/" + this.id)
                .then(res=>res.json())
                .then(bs => {
                    this.album = bs[0]
                    this.album.issue_date = new Date(this.album.issue_date);
                    for( let item of this.album.singers){
                        item.singer_id = parseInt(item.singer_id);
